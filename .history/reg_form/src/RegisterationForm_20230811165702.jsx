import { FormControl, FormLabel, Input, Box, InputRightElement, InputGroup, Button, Text } from "@chakra-ui/react";
...
function RegisterationForm() {
  ...
  const handlePasswordChange = (e) => {
    ...
    if (score >= 3) {
      ...
      strengthLabel = "Weak"; // Set "Weak" label if score is lower
    }
